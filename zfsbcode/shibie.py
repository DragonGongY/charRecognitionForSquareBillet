...
model_weights = '/media/gsy/D02497132496FC22/Users/Administrator/Desktop/zfsb/recognition/VGG_VOC0712_SSD_300x300_iter_15000.caffemodel'
...
picfiles = os.listdir('/home/gsy/pics/')
for p in picfiles:
    # set net to batch size of 1t
    image_resize = 300
    net.blobs['data'].reshape(1,3,image_resize,image_resize)

    image = caffe.io.load_image('/home/gsy/pics/' + p)
    plt.imshow(image)
    ...
    plt.savefig('/home/gsy/results/' + p)
    plt.close()
